                        ...
                        <form className="uk-grid-small" uk-grid="true">
                            <div className="uk-margin">
                                <div className="uk-inline uk-width-1-1">
                                    <input name="title" className="uk-input" placeholder="Title..." onChange={event => setTitle(event.target.value)} />
                                </div>
                            </div>
                            <div className="uk-margin">
                                <div className="uk-inline uk-width-1-1">
                                    <input name="year" className="uk-input" placeholder="Year of distribution..." onChange={event => setYear(event.target.value)} />
                                </div>
                            </div>
                            <div className="uk-margin">
                                <button className="uk-button uk-button-primary uk-button-large uk-width-1-1" onClick={axiosData}>Soumettre la recherche</button>
                            </div>
                        </form>
                    </div>
                </div>
